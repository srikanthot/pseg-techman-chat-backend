"""
FastAPI application entry point for the MANGOS Tech Manual Agent Backend.
...
async def lifespan(app: FastAPI):
    ...
    logger.info("MANGOS Tech Manual Agent Backend starting up")
    logger.info(
    ...
    yield
    logger.info("MANGOS Tech Manual Agent Backend shutting down")


app = FastAPI(
    title="MANGOS Tech Manual Agent Backend",
    description=(
        "Agent Framework SDK-based RAG API for MANGOS field technician manuals.\n\n"
